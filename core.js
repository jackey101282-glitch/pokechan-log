...
const TYPE_ICON = {
  // ドーナツ（円環）
  ノーマル:'M6 1.3a4.7 4.7 0 100 9.4 4.7 4.7 0 000-9.4zm0 2.6a2.1 2.1 0 110 4.2 2.1 2.1 0 010-4.2z',
  // 炎
  ほのお:'M6.4.7c.4 2-.6 2.8-1.6 3.8-1 1-1.9 2-1.9 3.3A3.1 3.1 0 006 11.1a3.1 3.1 0 003.1-3.3c0-1.1-.5-1.9-1.1-2.7-.3.6-.7 1-1.2 1.2.6-2 .1-4-1.4-5.6z',
  // しずく
  みず:'M6 .9C4 3.4 2.7 5.2 2.7 7A3.3 3.3 0 006 10.4 3.3 3.3 0 009.3 7C9.3 5.2 8 3.4 6 .9z',
  // 稲妻
  でんき:'M7.9.8L2.9 6.6h2.4L4.2 11.2 9.2 5.1H6.8L7.9.8z',
  // 葉
  くさ:'M10.6 1.1C5.7.8 2.3 2.7 1.9 6.3c-.2 1.9.6 3.4 1.9 4.4.3-2.8 1.7-4.9 4.2-6.1C6 5.9 4.6 7.8 4.3 10.8c4.1.7 6.7-3 6.3-9.7z',
  // 雪の結晶（6方向）
  こおり:'M5.3 1.4H6.7V10.6H5.3ZM7.69 10.33L8.91 9.63L4.31 1.67L3.09 2.37ZM3.09 9.63L4.31 10.33L8.91 2.37L7.69 1.67Z',
  // 拳
  かくとう:'M2.6 4.2c0-.5.4-.9.9-.9h.6V2.5c0-.5.4-.9.9-.9s.9.4.9.9v.8h.5V2.2c0-.5.4-.9.9-.9s.9.4.9.9v1.1h.4c.5 0 .9.4.9.9v2.6A3.4 3.4 0 016 10.4a3.4 3.4 0 01-3.4-3.6V4.2z',
  // 毒（丸＋垂れ）
  どく:'M6 1C4 3.3 2.8 4.9 2.8 6.6A3.2 3.2 0 006 9.9a3.2 3.2 0 003.2-3.3C9.2 4.9 8 3.3 6 1zM4.9 5.2c.45 0 .8.4.8.9s-.35.9-.8.9-.8-.4-.8-.9.35-.9.8-.9zm2.2 0c.45 0 .8.4.8.9s-.35.9-.8.9-.8-.4-.8-.9.35-.9.8-.9z',
  // 山（じめん）
  じめん:'M6 2.1l2.6 4.2H3.4L6 2.1zM2.9 6.9L1 10h10L9.1 6.9H2.9z',
  // 翼
  ひこう:'M1 6.6c2.4-.4 4-1.4 5.2-3 .5-.7 1.4-1.1 2.3-1.1.9 0 1.6.4 1.6 1.1 0 .6-.5 1-1.1 1.1.5.2.8.6.8 1.1 0 .9-.9 1.5-2.1 1.5-.6 0-1.1-.1-1.6-.4-.8.8-2 1.4-3.6 1.6L1 6.6z',
  // 渦（エスパー）
  エスパー:'M6 1.1a4.9 4.9 0 00-4.9 4.9c0 1.9 1.5 3.4 3.4 3.4 1.5 0 2.7-1.2 2.7-2.7 0-1.2-1-2.2-2.2-2.2-.9 0-1.7.8-1.7 1.7 0 .7.6 1.3 1.3 1.3.3 0 .5-.1.7-.3-.1.5-.6.9-1.2.9-.9 0-1.6-.7-1.6-1.6 0-1.3 1-2.3 2.3-2.3 1.6 0 2.9 1.3 2.9 2.9 0 1.9-1.5 3.4-3.4 3.4h-.2a4.9 4.9 0 002.8.5A4.9 4.9 0 006 1.1z',
  // 虫
  むし:'M4.1 1.2l1.2 1.4c.2-.1.4-.1.7-.1s.5 0 .7.1l1.2-1.4.7.6-1.1 1.3c.7.5 1.1 1.3 1.1 2.2v.4h1.6v.9H8.6v.5c0 .3 0 .6-.1.9h1.7v.9H8.1c-.5.7-1.3 1.1-2.1 1.1s-1.6-.4-2.1-1.1H2.2v-.9h1.7c-.1-.3-.1-.6-.1-.9v-.5H2.2v-.9h1.6v-.4c0-.9.4-1.7 1.1-2.2L3.4 1.8l.7-.6z',
  // 岩
  いわ:'M4.4 2.4h3.6l1.7 2.6-1.2 1.1H3.5L2.3 5l2.1-2.6zM2.6 6.9h6.8L10.6 10H1.4l1.2-3.1z',
  // おばけ
  ゴースト:'M6 1.1a3.9 3.9 0 00-3.9 3.9v5.6l1.3-1.1 1.3 1.1L6 9.5l1.3 1.1 1.3-1.1 1.3 1.1V5A3.9 3.9 0 006 1.1zM4.7 4.1c.4 0 .7.4.7.9s-.3.9-.7.9-.7-.4-.7-.9.3-.9.7-.9zm2.6 0c.4 0 .7.4.7.9s-.3.9-.7.9-.7-.4-.7-.9.3-.9.7-.9z',
  // 竜
  ドラゴン:'M9.9 2.1c-1 .2-1.9.6-2.6 1.2L6 2.1 4.7 3.3C3.6 2.6 2.5 2.2 1.3 2.1c.5 1.1 1.3 2 2.3 2.6-.4.6-.6 1.3-.6 2A3.4 3.4 0 006.4 10c1.9 0 3.4-1.5 3.4-3.4 0-.6-.2-1.2-.5-1.7 1-.6 1.8-1.6 2.3-2.7-.6 0-1.2 0-1.7-.1zM5 5.6c.4 0 .7.3.7.8s-.3.8-.7.8-.7-.3-.7-.8.3-.8.7-.8z',
  // 三日月
  あく:'M8.4 1.3A4.8 4.8 0 006 10.7c1.4 0 2.7-.6 3.6-1.6a3.9 3.9 0 01-1.2-7.8z',
  // 六角ボルト
  はがね:'M6 1.1L1.9 3.5v5L6 10.9l4.1-2.4v-5L6 1.1zm0 2.5l2 1.2v2.4l-2 1.2-2-1.2V4.8l2-1.2z',
  // 四方の輝き（フェアリー）
  フェアリー:'M6 1l1.1 2.5L9.6 2.4 8.5 4.9 11 6l-2.5 1.1 1.1 2.5-2.5-1.1L6 11 4.9 8.5 2.4 9.6l1.1-2.5L1 6l2.5-1.1L2.4 2.4l2.5 1.1L6 1zm0 3.2a1.8 1.8 0 100 3.6 1.8 1.8 0 000-3.6z'
};
